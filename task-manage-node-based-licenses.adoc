...
[role="lead"]
Gestiona las licencias basadas en nodos en la cartera digital para garantizar que cada sistema de Cloud Volumes ONTAP tenga una licencia válida con la capacidad requerida.
...
+
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-deleting-working-env.html["Aprenda a eliminar un entorno de trabajo de Cloud Volumes ONTAP"].
